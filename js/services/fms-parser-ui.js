...
(function (window, document) {
    ...
    const CONFIG = {
        CPGRAMS: {
            ...
            mapping: {
                grievanceNumber:"grievanceNumber", dateReceived:"dateReceived", dueDate:"dueDate",
                subject:"subject", grievanceDescription:"grievanceDescription", category:"category",
                nature:"natureOfGrievance", priority:"priorityClassification", complainantName:"complainantName",
                mobile:"mobileNumber", email:"email", district:"districtManual", mandal:"mandalManual",
                village:"villageManual", address:"address", department:"Department", section:"Section",
                fileNumber:"fileNumber", dateArised:"dateArised", subject:"officeSubject",
        ...
        RTI: {
            ...
            accept: ".pdf,.txt,.png,.jpg,.jpeg",
            mapping: {
                applicationNumber:"applicationNumber", applicationDate:"applicationDate", dueDate:"dueDate",
                ...
                concernedSection:"concernedSection", replyFurnishedByConcernedSectionDate:"replyFurnishedByConcernedSectionDate",
                finalReplySentToPIODate:"finalReplySentToPIODate",
                officeFileNo:"officeFileNo", officeDateArised:"officeDateArised", subject:"officeSubject",
                communicationType:"officeCommunicationType", letterAddressedTo:"officeLetterAddressedTo",
                replyObtainedFrom:"officeReplySection", fileStatus:"officeStatus"
            }
        },
        DISHA: {
            ...
            accept: ".pdf,.txt,.png,.jpg,.jpeg",
            mapping: {
                slNo:"slNo", district:"district", dateOfMeeting:"dateOfMeeting", pomDueDate:"pomDueDate",
                ...
                fileNumber:"officeFileNo", dateArised:"officeDateArised", subject:"officeSubject",
                communicationType:"officeCommunicationType", letterAddressedTo:"officeLetterAddressedTo",
                replyObtainedFrom:"officeReplySection", fileStatus:"officeStatus"
            }
        }
    ...
    async function run(module, file, config, status, confidence, preview) {
        ...
        // CPGRAMS supports both master dropdowns and manual fallback boxes.
        if (module === "CPGRAMS") {
            parsedFields.districtManual = parsedFields.district;
            parsedFields.mandalManual = parsedFields.mandal;
            parsedFields.villageManual = parsedFields.village;
        }
        const changed = window.FMSParserService.fillFields(parsedFields, {
            ...config.mapping,
            ...(module === "CPGRAMS" ? {
                districtManual:"districtManual",
                mandalManual:"mandalManual",
                villageManual:"villageManual"
            } : {})
        }, { onlyEmpty: true });
