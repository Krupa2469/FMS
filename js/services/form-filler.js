...
setValue(
    ...
    setValue(
        "officeFileNo",
        data.officeFileNo || data.fileNumber || data.fileNo
    );
    ...
    setValue(
        "officeDateArised",
        data.officeDateArised || data.dateArised
    );

    /*
     * Office Communication Type
     */
    setValue(
        "officeCommunicationType",
        data.communicationType || data.typeOfCommunication
    );
    ...
    setValue(
        ...
        data.letterAddressedTo || data.addressedTo
    );

    /*
     * Reply Obtained From / Section
     */
    setValue(
        "officeReplySection",
        data.replyObtainedFrom || data.officeReplyObtainedFrom || data.section
    );
