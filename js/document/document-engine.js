...
<<<<<<< HEAD
            ...
            if (
                ...
                if (typeof Tesseract === "undefined") {
                    throw new Error("Tesseract.js is not loaded. OCR cannot continue.");
                }
                const result = await Tesseract.recognize(file, "eng", {
                    logger: function (message) {
                        if (message.status) console.log("OCR:", message.status, message.progress);
                    }
                });
                return {
...
<<<<<<< HEAD
            ...
            if (window.FMSModuleParsers && typeof window.FMSModuleParsers.CPGRAMS === "function") {
                try {
                    return window.FMSModuleParsers.CPGRAMS(text);
                } catch (error) {
                    console.warn("CPGRAMS central parser warning:", error);
                }
            }
