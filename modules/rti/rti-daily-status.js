...
async function refreshRTIDailyStatus() {
    try {
        ...
        calculateRTISummary();
        updateRTIDailyStatus();
        console.log("RTI Daily Status refreshed.");
    } catch (error) {
        console.error("RTI Daily Status Refresh Error:", error);
        showError("Unable to refresh RTI Daily Status. " + error.message);
    }
}
...
async function shareRTIWhatsApp() {
    try {
        if (window.FMSWhatsAppService) {
            return await window.FMSWhatsAppService.shareDailyStatus({
                module: "RTI",
                title: "RTI Daily Status Report",
                element: document.querySelector(".report-container") || document.querySelector("main") || document.body
            });
        }
    } catch (error) {
        console.error("RTI WhatsApp share failed:", error);
        showError("Unable to share RTI Daily Status. " + error.message);
    }
}
...
document.addEventListener("DOMContentLoaded", function() {
  const b=document.getElementById("btnWhatsAppDaily");
