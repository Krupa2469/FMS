...
async function shareDishaDailyStatusWhatsApp() {
    try {
        const records = await loadDishaWhatsAppRecords();
        const message = buildDishaWhatsAppMessage(records);
        ...
        return {success:true, method:"whatsapp-text", excelExported:false};
    } catch (error) {
        console.error("DISHA WhatsApp Error:", error);
