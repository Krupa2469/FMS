...
function registerButtonEvents() {
    ...
    document.getElementById("btnWhatsApp")?.addEventListener("click", async function () {
        ...
        await window.FMSWhatsAppService.share({
            module: "CPGRAMS",
            title: "CPGRAMS Grievance Report",
            fields: [
                {id:"grievanceNumber",label:"Grievance Number"},
            ...
            element: document.querySelector("#cpgramsForm") || document.body,
            message: (msg)=>showMessage("info", msg)
        });
    });
