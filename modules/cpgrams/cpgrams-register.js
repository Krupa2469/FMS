"use strict";
/* ============================================================
   GRIEVANCES REGISTER CONTROLLER - v1.5.9
...
(function(window,document){
  ...
  function init(){console.log("CPGRAMS Register v1.5.9 loaded");populateTypeDropdown();populateFY();bind();bindExternalRefresh();renderTable();loadRegister();}
