"use strict";
/* ============================================================
   GRIEVANCES REGISTER CONTROLLER - v1.6.0
...
(function(window,document){
  ...
  function init(){console.log("CPGRAMS Register v1.6.0 loaded");populateTypeDropdown();populateFY();bind();bindExternalRefresh();renderTable();loadRegister();}
